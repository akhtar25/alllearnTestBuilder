...
function autocomplete(inp, arr) {
  ...
  var states = ["Andaman and Nicobar Islands (union territory)","Andhra Pradesh","Arunachal Pradesh","Assam","Bihar","Chandigarh (union territory)","Chhattisgarh","Dadra and Nagar Haveli (union territory)","Daman and Diu (union territory)","Delhi (national capital territory)","Goa","Gujarat","Haryana","Himachal Pradesh","Jammu and Kashmir","Jharkhand","Karnataka","Kerala","Madhya Pradesh","Maharashtra","Manipur","Meghalaya","Mizoram","Nagaland","Odisha","Puducherry (union territory)","Punjab","Rajasthan","Sikkim","Tamil Nadu","Telangana","Tripura","Uttar Pradesh","Uttarakhand"]
