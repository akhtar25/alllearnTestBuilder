...
$(document).ready(function() {
  ...
  $('#datatable').dataTable({
    "oLanguage": {
      ...
      "sLengthMenu": '<span style="font-size:14px;">Rows per page:</span><select class="browser-default">' +
        ...
        '<option value="-1" style="font-size:14px;">All</option>' +
        '</select></div>'
    },
    bAutoWidth: false,
    ...
    buttons: [
       ...
       {
         text: '<span style="color:#4d4d4d; margin-right:15px;font-size:15px;">Excel<span>',
         extend: 'excelHtml5',
       },
       {
         text: '<span style="color:#4d4d4d; margin-right:15px;font-size:15px;">Csv<span>',
         extend: 'csvHtml5',
       },
       {

         text: '<span style="color:#4d4d4d; margin-right:15px;font-size:15px;">Copy<span>',
         extend: 'copyHtml5',
