...
def testLinkWhatsappBot(): 
    ...
    if student:
        ...
        return redirect(url_for('feedbackCollectionStudDev.html',resp_session_id=respsessionid,school_id=teacher.school_id,uploadStatus=uploadStatus,resultStatus=resultStatus,advance=advance,_external=True))
        ...
        return redirect(url_for('feedbackCollectionTeachDev.html',classSecCheckVal='Y', subject_id=subject_id, 
