...
def syllabusChapters():
    ...
    distinctChapterQuery=distinctChapterQuery+ "on t1.book_id=t2.book_id where t2.book_id= '"+book_id+"' and t1.class_val ='"+class_val+"' and t1.board_id='"+board_id+"' and t1.subject_id='"+subject_id+"'"
