...
def test_report_email(email,name,school,school_id,exam_date,test_type,resp_session_id,student_id):
    print('Email:'+str(email))
    print('Name:'+str(name))
    ...
    subject = "allLearn - Notification for %s Test" % test_type
    message = render_template('test_notification_email.html',exam_date=exam_date,school_id=school_id,student_id=student_id,name=name)
    send_email(email,name,subject,message)
