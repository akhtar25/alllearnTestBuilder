...
class Config(object):
    ...
    EMAIL_API_KEY = "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"
    SQLALCHEMY_DATABASE_URI = DATABASE_URL + '?sslmode=require'
    ELASTICSEARCH_URL = "http://paas:9e8a515468ee63f4e98004f2e694f333@thorin-us-east-1.searchly.com"
    ...
    #TEST CREDS
    ALLLEARN_CASHFREE_APP_ID =  "1QAZXSW2JJJJ4RFVLI8761919ASDF654ASDF5D5D222"
